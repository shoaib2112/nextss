...
angular.module('nextGrid').controller('assetCtrl', function ($scope, $uibModalInstance) {
    $scope.ok = function () {
...
angular.module('nextGrid').controller('showMatrixCtrl', function ($scope, $uibModalInstance, DataModel) {
...
angular.module('nextGrid').controller('showVineCtrl', function($scope, $uibModalInstance, $uibModal) {
...
angular.module('nextGrid').controller('condCtrl', function($scope, $uibModalInstance) {
    $scope.ok = function () {
        $uibModalInstance.close();
    };
